...
function HDWalletProvider(
  ...
  // hack1: make signTypedData work
  {
    let origHandler = hookedSubprovider.handleRequest.bind(hookedSubprovider);
    hookedSubprovider.handleRequest = function(payload, next, end) {
      switch(payload.method) {
        case 'eth_signTypedData':
          next();
          break;
        default:
          return origHandler(payload, next, end)
      }
    }
  }
